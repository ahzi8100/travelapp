                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="align-middle">
                                                <img src="{{ url('frontend/images/avatar1.jpg') }}" alt="">
                                            </td>
                                            <td class="align-middle">
                                                Angga Risky
                                            </td>
                                            ...
                                            <td class="align-middle">
                                                <a href="#">
                                                    <img src="{{ url('frontend/images/ic_remove.jpg') }}" alt="">
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="align-middle">
                                                <img src="{{ url('frontend/images/avatar2.jpg') }}" alt="">
                                            </td>
                                            <td class="align-middle">
                                                Galih Pratama
                                            </td>
                            ...
                            <div class="member mt-3">
                                ...
                                <form action="" class="form-inline">
                                    ...
                                    <div class="input-group mb-2 mr-sm-2">
                                        <input type="text" class="form-control datepicker" id="doePicker"
                        ...
                        <div class="card card-details card-right">
                            ...
                            <table class="trip-informations">
                                ...
                                <tr>
                                    ...
                                    <td width="50%" class="text-right text-total"><span class="text-blue">$279, </span>
                            ...
                            <div class="bank">
                                <div class="bank-item pb-3">
                                    <img src="{{ url('frontend/images/ic_bank.jpg') }}" class="bank-image">
